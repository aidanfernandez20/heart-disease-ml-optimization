...
from sklearn.linear_model import LogisticRegression  # only if you don't have this already, but not used below
from sklearn.metrics import roc_curve, auc

# -------------------------------------------------------------------
# ROC CURVE: Optimized KNN vs Optimized Random Forest
# -------------------------------------------------------------------

# Make sure best_knn and best_rf are already created in Step 4A
...
for name, model in roc_models.items():
    # Fit on training data (safe to refit)
    model.fit(X_train_scaled, y_train)
...
plt.title("ROC Curves: Optimized KNN vs Optimized Random Forest")
...
# -------------------------------------------------------------------
# THRESHOLD VS FALSE NEGATIVES: KNN and Random Forest
# -------------------------------------------------------------------
...
for thr in thresholds:
    # KNN
    y_pred_knn = (y_proba_knn >= thr).astype(int)
...
plt.plot(thresholds, fn_knn, marker='o', label="Optimized KNN")
plt.plot(thresholds, fn_rf, marker='s', label="Optimized Random Forest")
plt.xlabel("Decision Threshold")
plt.ylabel("Number of False Negatives")
plt.title("Threshold vs False Negatives (KNN & Random Forest)")
plt.legend()
plt.grid(True)
plt.show()